...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.WorkspacesApi();
  });
  ...
  describe('WorkspacesApi', function() {
    ...
    describe('singleworkspace', function() {
      it('should call singleworkspace successfully', function(done) {
        //uncomment below and update the code to test singleworkspace
        //instance.singleworkspace(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
