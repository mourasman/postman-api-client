...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.SchemaApi();
  });
  ...
  describe('SchemaApi', function() {
    ...
    describe('createcollectionfromschema', function() {
      it('should call createcollectionfromschema successfully', function(done) {
        //uncomment below and update the code to test createcollectionfromschema
        //instance.createcollectionfromschema(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
