...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Workspace4();
  });
  ...
  describe('Workspace4', function() {
    it('should create an instance of Workspace4', function() {
      // uncomment below and update the code to test Workspace4
      //var instane = new PostmanApi.Workspace4();
      //expect(instance).to.be.a(PostmanApi.Workspace4);
    });
