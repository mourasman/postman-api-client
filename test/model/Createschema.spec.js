...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Createschema();
  });
  ...
  describe('Createschema', function() {
    it('should create an instance of Createschema', function() {
      // uncomment below and update the code to test Createschema
      //var instane = new PostmanApi.Createschema();
      //expect(instance).to.be.a(PostmanApi.Createschema);
    });
