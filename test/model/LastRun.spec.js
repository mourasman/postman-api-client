...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.LastRun();
  });
  ...
  describe('LastRun', function() {
    it('should create an instance of LastRun', function() {
      // uncomment below and update the code to test LastRun
      //var instane = new PostmanApi.LastRun();
      //expect(instance).to.be.a(PostmanApi.LastRun);
    });
