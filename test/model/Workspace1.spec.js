...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Workspace1();
  });
  ...
  describe('Workspace1', function() {
    it('should create an instance of Workspace1', function() {
      // uncomment below and update the code to test Workspace1
      //var instane = new PostmanApi.Workspace1();
      //expect(instance).to.be.a(PostmanApi.Workspace1);
    });
