...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Workspace2();
  });
  ...
  describe('Workspace2', function() {
    it('should create an instance of Workspace2', function() {
      // uncomment below and update the code to test Workspace2
      //var instane = new PostmanApi.Workspace2();
      //expect(instance).to.be.a(PostmanApi.Workspace2);
    });
