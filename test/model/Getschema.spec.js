...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Getschema();
  });
  ...
  describe('Getschema', function() {
    it('should create an instance of Getschema', function() {
      // uncomment below and update the code to test Getschema
      //var instane = new PostmanApi.Getschema();
      //expect(instance).to.be.a(PostmanApi.Getschema);
    });
