...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Relations();
  });
  ...
  describe('Relations', function() {
    it('should create an instance of Relations', function() {
      // uncomment below and update the code to test Relations
      //var instane = new PostmanApi.Relations();
      //expect(instance).to.be.a(PostmanApi.Relations);
    });
