...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Updateschema();
  });
  ...
  describe('Updateschema', function() {
    it('should create an instance of Updateschema', function() {
      // uncomment below and update the code to test Updateschema
      //var instane = new PostmanApi.Updateschema();
      //expect(instance).to.be.a(PostmanApi.Updateschema);
    });
