...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Monitor2();
  });
  ...
  describe('Monitor2', function() {
    it('should create an instance of Monitor2', function() {
      // uncomment below and update the code to test Monitor2
      //var instane = new PostmanApi.Monitor2();
      //expect(instance).to.be.a(PostmanApi.Monitor2);
    });
