...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Request6();
  });
  ...
  describe('Request6', function() {
    it('should create an instance of Request6', function() {
      // uncomment below and update the code to test Request6
      //var instane = new PostmanApi.Request6();
      //expect(instance).to.be.a(PostmanApi.Request6);
    });
