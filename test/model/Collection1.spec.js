...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Collection1();
  });
  ...
  describe('Collection1', function() {
    it('should create an instance of Collection1', function() {
      // uncomment below and update the code to test Collection1
      //var instane = new PostmanApi.Collection1();
      //expect(instance).to.be.a(PostmanApi.Collection1);
    });
