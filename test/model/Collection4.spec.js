...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Collection4();
  });
  ...
  describe('Collection4', function() {
    it('should create an instance of Collection4', function() {
      // uncomment below and update the code to test Collection4
      //var instane = new PostmanApi.Collection4();
      //expect(instance).to.be.a(PostmanApi.Collection4);
    });
