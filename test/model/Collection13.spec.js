...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Collection13();
  });
  ...
  describe('Collection13', function() {
    it('should create an instance of Collection13', function() {
      // uncomment below and update the code to test Collection13
      //var instane = new PostmanApi.Collection13();
      //expect(instance).to.be.a(PostmanApi.Collection13);
    });
