...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.CreateCollectionRequest();
  });
  ...
  describe('CreateCollectionRequest', function() {
    it('should create an instance of CreateCollectionRequest', function() {
      ...
      //var instane = new PostmanApi.CreateCollectionRequest();
      //expect(instance).to.be.a(PostmanApi.CreateCollectionRequest);
    });
