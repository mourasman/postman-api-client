...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.UpdateEnvironmentRequest();
  });
  ...
  describe('UpdateEnvironmentRequest', function() {
    it('should create an instance of UpdateEnvironmentRequest', function() {
      ...
      //var instane = new PostmanApi.UpdateEnvironmentRequest();
      //expect(instance).to.be.a(PostmanApi.UpdateEnvironmentRequest);
    });
