...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Getrelationsofatype1();
  });
  ...
  describe('Getrelationsofatype1', function() {
    it('should create an instance of Getrelationsofatype1', function() {
      // uncomment below and update the code to test Getrelationsofatype1
      //var instane = new PostmanApi.Getrelationsofatype1();
      //expect(instance).to.be.a(PostmanApi.Getrelationsofatype1);
    });
