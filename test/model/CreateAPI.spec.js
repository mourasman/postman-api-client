...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.CreateAPI();
  });
  ...
  describe('CreateAPI', function() {
    it('should create an instance of CreateAPI', function() {
      // uncomment below and update the code to test CreateAPI
      //var instane = new PostmanApi.CreateAPI();
      //expect(instance).to.be.a(PostmanApi.CreateAPI);
    });
