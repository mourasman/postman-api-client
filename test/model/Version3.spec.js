...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Version3();
  });
  ...
  describe('Version3', function() {
    it('should create an instance of Version3', function() {
      // uncomment below and update the code to test Version3
      //var instane = new PostmanApi.Version3();
      //expect(instance).to.be.a(PostmanApi.Version3);
    });
