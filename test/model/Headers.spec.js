...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmanApi.Headers();
  });
  ...
  describe('Headers', function() {
    it('should create an instance of Headers', function() {
      ...
      //var instane = new PostmanApi.Headers();
      //expect(instance).to.be.a(PostmanApi.Headers);
    });
    ...
    it('should have the property acceptEncoding (base name: "accept-encoding")', function() {
      // uncomment below and update the code to test the property acceptEncoding
      //var instane = new PostmanApi.Headers();
      //expect(instance).to.be();
    });

    it('should have the property contentLength (base name: "content-length")', function() {
