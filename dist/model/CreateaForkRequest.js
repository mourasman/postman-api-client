 ...
 * @version 1.0.0
 */
var CreateaForkRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateaForkRequest</code>.
   * @alias module:model/CreateaForkRequest
   * @param name {String} 
   */
  function CreateaForkRequest(name) {
    _classCallCheck(this, CreateaForkRequest);
  ...
  _createClass(CreateaForkRequest, null, [{
    key: "initialize",
...
var _default = CreateaForkRequest;
