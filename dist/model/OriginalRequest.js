...
var _Url = _interopRequireDefault(require("./Url1"));
...
var OriginalRequest = /*#__PURE__*/function () {
   ...
   */
  function OriginalRequest(method, header, url) {
    _classCallCheck(this, OriginalRequest);
  ...
  _createClass(OriginalRequest, null, [{
    key: "initialize",
    value: function initialize(obj, method, header, url) {
      obj['method'] = method;
      obj['header'] = header;
      obj['url'] = url;
    }
